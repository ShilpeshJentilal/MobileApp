...
class SurveyQuestion3_Activity : AppCompatActivity() {
    ...
    fun setQueston(surveyID:String){
        ...
        var question :String = questionlist.get(2).QuestionText
        var question1 = findViewById<TextView>(R.id.txtTakeQuestion3)
        question1.text = "3. $question"
    }
    ...
    fun gotoNextQuestion(view: View){
        ...
        var questionID :String = questionlist.get(2).Id.toString()
