...
class SurveyQuestion2_Activity : AppCompatActivity() {
    ...
    fun setQueston(surveyID:String){
        ...
        var question :String = questionlist.get(1).QuestionText
        var question1 = findViewById<TextView>(R.id.txtTakeQuestion2)
        question1.text = "2. $question"
    }
    ...
    fun gotoNextQuestion(view: View){
        ...
        var questionID :String = questionlist.get(1).Id.toString()
