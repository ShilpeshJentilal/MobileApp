...
class StudentSurveyQuestion8Controller : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_survey_question8)
    ...
    // Set the eighth question based on the survey ID
    fun setQuestion(surveyID: String) {
        val questionList: ArrayList<Question> = db.getQuestions(surveyID)
        val question: String = questionList[7].QuestionText
        val questionTextView = findViewById<TextView>(R.id.txtTakeQuestion8)
        questionTextView.text = "8. $question"
    }

    // Proceed to the next question
    fun gotoNextQuestion(view: View) {
        val radioButton1 = findViewById<RadioButton>(R.id.rdq8a1)
        val radioButton2 = findViewById<RadioButton>(R.id.rdq8a2)
        val radioButton3 = findViewById<RadioButton>(R.id.rdq8a3)
        val radioButton4 = findViewById<RadioButton>(R.id.rdq8a4)
        val radioButton5 = findViewById<RadioButton>(R.id.rdq8a5)

        val surveyId = intent.getStringExtra("PublishSurvey").toString()
        val questionList: ArrayList<Question> = db.getQuestions(surveyId)
        val questionId: String = questionList[7].Id.toString()
        ...
        if(radioButton1.isChecked || radioButton2.isChecked || radioButton3.isChecked || radioButton4.isChecked || radioButton5.isChecked) {
            val radioGroup = findViewById<RadioGroup>(R.id.radioA8)
