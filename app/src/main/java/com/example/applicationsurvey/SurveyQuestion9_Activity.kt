...
class SurveyQuestion9_Activity : AppCompatActivity() {
    ...
    fun setQueston(surveyID:String){
        ...
        var question :String = questionlist.get(8).QuestionText
        var question1 = findViewById<TextView>(R.id.txtTakeQuestion9)
    ...
    fun gotoNextQuestion(view: View){
        ...
        var questionID :String = questionlist.get(8).Id.toString()
        ...
        if(radioButton1.isChecked||radioButton2.isChecked||radioButton3.isChecked||radioButton4.isChecked||radioButton5.isChecked) {
            ...
            val intent = Intent(this, SurveyQuestion10_Activity::class.java)
