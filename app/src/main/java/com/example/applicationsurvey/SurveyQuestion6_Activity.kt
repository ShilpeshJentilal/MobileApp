...
class SurveyQuestion6_Activity : AppCompatActivity() {
    ...
    fun setQueston(surveyID:String){
        ...
        var question :String = questionlist.get(5).QuestionText
        var question1 = findViewById<TextView>(R.id.txtTakeQuestion6)
        question1.text = "6. $question"
    }
    ...
    fun gotoNextQuestion(view: View){
        ...
        var questionID :String = questionlist.get(5).Id.toString()
