...
class SurveyQuestion5_Activity : AppCompatActivity() {
    ...
    fun setQueston(surveyID:String){
        ...
        var question :String = questionlist.get(4).QuestionText
        var question1 = findViewById<TextView>(R.id.txtTakeQuestion5)
        question1.text = "5. $question"
    }
    ...
    fun gotoNextQuestion(view: View){
        ...
        var questionID :String = questionlist.get(4).Id.toString()
    ...
    fun gotoPreviousQuestion(view: View){
        ...
        val intent = Intent(this, SurveyQuestion4_Activity::class.java)
        intent.putExtra("PublishSurvey",ps)
        intent.putExtra("PublishSurveyId",publishedSurveyID)
        intent.putExtra("StudentId",studentId)
        startActivity(intent)
