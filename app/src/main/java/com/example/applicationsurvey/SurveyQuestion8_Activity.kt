...
class SurveyQuestion8_Activity : AppCompatActivity() {
    ...
    fun setQueston(surveyID:String){
        ...
        var question :String = questionlist.get(7).QuestionText
        var question1 = findViewById<TextView>(R.id.txtTakeQuestion8)
        question1.text = "8. $question"
    }
    ...
    fun gotoNextQuestion(view: View){
        ...
        var questionID :String = questionlist.get(7).Id.toString()
    ...
    fun gotoPreviousQuestion(view: View){
        ...
        val intent = Intent(this, SurveyQuestion7_Activity::class.java)
        intent.putExtra("PublishSurvey",ps)
        intent.putExtra("PublishSurveyId",publishedSurveyID)
        intent.putExtra("StudentId",studentId)
        startActivity(intent)
